...
$sql = "INSERT INTO `bookcase_id_police`(`Caseid`, `dateviolation`, `reason`) VALUES ('$ID','$date','$bookingReason')";
...
<body>
  <div class="container">
  <?php
    $query = "SELECT * FROM bookcase_id_police ORDER BY dateviolation DESC LIMIT 1";
    ...
    <div class="content">
      <form action="connect_police_records.php" method="post">
      <div class="offence-details">
          ...
          <div class="input-box">
            <span class="details">Driver's Name</span>
            <input type="text" name="driversname" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            <span class="details">Phone Number of Driver's</span>
            <input type="text" name="dphno" required>
          </div>
          <div class="input-box">
            <span class="details">Car Owner's Name</span>
            <input type="text"  name="cname" required>
          </div>
          <div class="input-box">
            <span class="details">Phone Number of Car Owner's</span>
            <input type="text"  name="cphno" required>
          </div>
          <div class="input-box">
