...
$sql = "INSERT INTO `report_history`(`dateviolation`, `ID`, `off.area`, `off.time`, `offence`, `fine`, `drivers name`, `drivers lisence`, `dph.no.`, `cars name`, `carsph.no.`, `carsnumber`, `offname`, `off.id.`) VALUES ('$date', '$ID', '$offarea', '$offtime', '$offence', '$fine', '$driversname', '$driverslisence', '$dphno', '$carsname', '$carsphno', '$carsnumber', '$offname', '$ofid')";
